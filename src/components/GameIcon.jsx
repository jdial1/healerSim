...
const frameSize = {
  ...
  dungeonCard: "h-14 w-14 min-h-14 min-w-14 p-1.5 sm:h-10 sm:w-10 sm:min-h-10 sm:min-w-10 sm:p-1",
  dungeonRoster: "h-10 w-10 min-h-10 min-w-10 p-1 sm:h-8 sm:w-8 sm:min-h-8 sm:min-w-8 sm:p-1",
  portrait: "h-28 w-28 min-h-28 min-w-28 p-2 sm:h-36 sm:w-36 sm:min-h-36 sm:min-w-36 sm:p-2.5",
...
function GameIcon({
  ...
  return React.createElement(
    ...
    React.createElement("div", { className: "relative flex h-full w-full min-h-0 items-center justify-center overflow-hidden rounded-sm" }, React.createElement(
      "img",
      {
        src,
        alt: "",
