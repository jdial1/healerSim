  ...
  return (
    ...
    >
      <div className="ui-splash-aurora" aria-hidden>
        ...
        <div className="ui-splash-note ui-splash-note-1" />
        <div className="ui-splash-note ui-splash-note-2" />
        <div className="ui-splash-note ui-splash-note-3" />
        <div className="ui-splash-note ui-splash-note-4" />
        <div className="ui-splash-vignette" />
      </div>
      <div className="ui-splash-animation-container" aria-hidden>
